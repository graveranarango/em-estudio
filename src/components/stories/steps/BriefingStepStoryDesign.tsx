...
export function BriefingStepStoryDesign() {
  const { goToNextStep } = useStoryProject();
  ...
  // Simular smart bindings - parseando mensajes del asistente
  useEffect(() => {
  ...
  const handleChipClick = (typeId: string) => {
    const selectedType = STORY_TYPES.find(t => t.id === typeId);
    if (selectedType) {
      setFormData(prev => ({
        ...prev,
        tipo: typeId
  ...
  return (
    <div className="h-full bg-canvas">
      ...
      <div className="h-full flex gap-4 p-4">
        {/* Panel izquierdo - Chat Maestro */}
        <div className="w-[460px] flex-shrink-0">
          <div className="h-full bg-white rounded-lg shadow-sm p-3 flex flex-col">
            {/* Header del chat */}
            ...
            {/* Ventana de chat */}
            <div className="flex-1 overflow-y-auto py-3 space-y-3" style={{ height: '560px' }}>
            ...
            <div className="pt-3 border-t border-gray-100 space-y-2">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-blue-500 text-white text-sm rounded hover:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed"
              >
        ...
        {/* Panel derecho - Formulario de detalles */}
